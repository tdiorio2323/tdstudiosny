...
import { CalendlyEmbed } from "@/features/contact/components/CalendlyEmbed"
...
export const metadata: Metadata = {
  ...
  description:
    "Schedule a free 30-minute consultation with TD Studios. Discuss your web design, development, or branding project with our team. No commitment required.",
  alternates: {
          ...
          <div className="mt-12 text-center">
            <p className="text-white/80 text-sm">
              ...
              <a
                ...
                className="text-white underline hover:text-white/80 min-h-[44px]"
              >
