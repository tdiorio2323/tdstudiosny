...
export const metadata: Metadata = {
  ...
  description:
    "Premium website design and digital experiences built for conversion. Strategy, UX architecture, and marketing sites that turn visitors into customers.",
  alternates: {
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-2xl mx-auto">
              Premium website design with luxury aesthetics, conversion-focused UX, and stunning
              visual storytelling.
            </p>
            <FrostedButton
              href="/contact"
              analyticsLabel="Web - Start Project"
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-white/80 text-lg">
                Conversion-optimized web experiences for modern brands
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <GlassCard className="luxury-glass">
                ...
                <p className="text-white text-sm">
                  Story-driven sections, SEO-focused architecture, and instrumented funnels built
                  for measurable wins.
                </p>
              </GlassCard>
              ...
              <GlassCard className="luxury-glass">
                ...
                <p className="text-white text-sm">
                  Modular content models, CMS-ready components, and asset optimization that keeps
                  teams shipping fast.
                </p>
              </GlassCard>
              ...
              <GlassCard className="luxury-glass">
                ...
                <p className="text-white text-sm">
                  Unified brand, docs, and support surfaces powered by design systems and
          ...
          <div className="max-w-4xl mx-auto px-6">
            <GlassCard className="luxury-glass p-8">
              ...
              <p className="text-white/90 text-lg leading-relaxed">
                We lead discovery, prototype reviews, and performance calibration alongside your
                marketing and product leads. Expect dependable handoff, documentation, and a roadmap
                for optimization.
              </p>
            </GlassCard>
          </div>
        ...
        <Section id="process" className="py-20">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-white/80 text-lg">
                From discovery to launch, we handle every detail
              </p>
            </div>
