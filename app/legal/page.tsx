...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service and Privacy Policy for TD Studios. Our commitment to transparency, data protection, and client rights for all design and development services.",
  alternates: {
            ...
            <GlassCard className="luxury-glass">
              <div className="prose prose-invert max-w-none">
                ...
                <p className="text-white/80 mb-4">
                  By accessing and using TD Studios' services, you accept and agree to be bound by
                  the terms and provision of this agreement.
                </p>

                <h3 className="text-xl font-semibold mt-6 mb-3">2. Service Description</h3>
                <p className="text-white/80 mb-4">
                  TD Studios provides professional design, development, and consulting services. All
                  services are provided "as is" and subject to the terms outlined in individual
                  project agreements.
                </p>

                <h3 className="text-xl font-semibold mt-6 mb-3">3. Intellectual Property</h3>
                <p className="text-white/80 mb-4">
                  Upon full payment, clients receive full ownership of all deliverables created
                  specifically for their project. TD Studios retains the right to showcase work in
                  our portfolio unless otherwise agreed.
                </p>

                <h3 className="text-xl font-semibold mt-6 mb-3">4. Payment Terms</h3>
                <p className="text-white/80 mb-4">
                  Payment terms are specified in individual project agreements. Typical structure is
                  50% upfront, 25% at midpoint, and 25% upon completion. Late payments may incur
                  fees.
                </p>

                <h3 className="text-xl font-semibold mt-6 mb-3">5. Project Timelines</h3>
                <p className="text-white/80 mb-4">
                  Project timelines are estimates based on agreed scope. Delays caused by client
                  feedback or change requests may extend the timeline accordingly.
                </p>

                <h3 className="text-xl font-semibold mt-6 mb-3">6. Termination</h3>
                <p className="text-white/80 mb-4">
                  Either party may terminate the agreement with written notice. Client remains
                ...
                <p className="text-white/80 mb-4">
                  TD Studios shall not be liable for any indirect, incidental, or consequential
            ...
            <GlassCard className="luxury-glass">
              <div className="prose prose-invert max-w-none">
                ...
                <p className="text-white/80 mb-4">
                  ...
                  necessary to provide our services or comply with legal requirements.
                </p>
                ...
                <p className="text-white/80 mb-4">
                  ...
                  Contact us at privacy@tdstudiosny.com to exercise these rights.
                </p>
                ...
                <p className="text-white/80 mb-4">
                  ...
                  privacy@tdstudiosny.com or (347) 485-9935.
                </p>
              </div>
            </GlassCard>
          </Section>
