...
export const clients: Client[] = [
  {
    ...
    testimonial: {
      quote:
        "TD Studios transformed our entire online presence. The new Shopify store and automated workflows have streamlined our operations and significantly boosted our sales.",
  ...
  },
  {
    ...
    year: "2024",
    services: ["Luxury brand identity", "Membership landing experience", "Email welcome journeys"],
    description:
  ...
  },
  {
    ...
    year: "2024",
    services: ["Personal brand kit", "Menu ordering app", "Content production"],
    description:
    ...
    testimonial: {
      quote:
        "The brand kit and ordering system TD Studios created elevated my culinary business to a whole new level. The design feels truly premium and the app makes booking seamless for my clients.",
  ...
  },
  {
    ...
    industry: "Restaurant",
    year: "2024",
    services: ["Hospitality brand refresh", "Reservations website", "Seasonal campaign toolkit"],
    description:
  ...
  },
  {
    ...
    year: "2024",
    services: ["Booking engine build", "Marketing automations", "Brand photography direction"],
    description:
    ...
    testimonial: {
      quote:
        "TD Studios' booking engine and marketing system transformed how we scale across markets. The automated workflows save us hours while maintaining our luxury brand standards.",
      author: "Sarah Chen",
  ...
  },
  {
    ...
    industry: "Finance",
    year: "2024",
    services: ["Investor portal redesign", "Pitch collateral system", "Compliance-ready CMS"],
    description:
  ...
  },
  {
    ...
    year: "2024",
    services: ["Lead-gen website", "Estimate request workflow", "CRM reporting setup"],
    description:
  ...
  },
  {
    ...
    industry: "Retail",
    year: "2024",
    services: ["Brand refresh", "Packaging design", "Shopify merchandising"],
    description:
  ...
  },
  {
    ...
    industry: "Media",
    year: "2024",
    services: ["Podcast network site", "Sponsorship kit", "Content repurposing workflows"],
    description:
  ...
  },
  {
    ...
    industry: "Media",
    year: "2024",
    services: ["Brand system expansion", "Social video templates", "Community hub"],
    description:
  ...
  },
  {
    ...
    industry: "Automotive",
    year: "2024",
    services: ["Performance landing pages", "Shop management dashboards", "Instagram content kits"],
    description:
  ...
  },
  {
    ...
    year: "2024",
    services: ["Property showcase site", "Investor pitch deck", "3D tour coordination"],
    description:
